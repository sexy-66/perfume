...
void main() {
  ...
  testWidgets('three SKU draft, immediate warning and 10.10g completion', (
    tester,
  ) async {
    ...
    final skus = <IngredientSkusData>[];
    for (final code in ['A', 'B', 'C']) {
      skus.add(
        await database.createIngredientSku(
